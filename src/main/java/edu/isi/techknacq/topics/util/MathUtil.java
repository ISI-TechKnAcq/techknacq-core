...
public class MathUtil {
    ...
    public static double GetIntSDnomax(ArrayList<Integer> a, double max,double mean){
        if(a.size()<2)
            return 0;
        else{
            double res=0;
    ...
    public static double GetLongSDnomax(ArrayList<Long> a, double max, double mean){
        if(a.size()<2)
            return 0;
        else{
            double res=0;
	...
	public static float SD(int []v){
        ...
        public static double Cosinsimilarity(ArrayList<Double> v1, ArrayList<Double> v2){
            if(v1.size()!=v2.size()){
