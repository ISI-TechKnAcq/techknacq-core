...
public class SortedWordPairList
{
    ...
    public static final String[] ENGLISH_STOP_WORDS = {
        "##","%","+","\\*","a", "aa", "ab", "about", "above", "ac", "across", "act","after", "again", "against", "al","all", "allah","almost", "alone", "along",
        "already", "also", "although", "always", "amazon","amazon.com","among", "an", "and", "anissaestk","another", "any", "anybody",
        "anyone", "anything", "anywhere","are", "area", "areas", "around","as","ask","asked","asking","asks",
        "at","august","away", "b","b b","b c", "b s", "b x", "back", "backed", "be", "became","because","become","been", "before", "began",
        "behind", "being", "beings", "between","bit","both","boy","brief","bro","btw","but", "bw","by", "c", "c b","came", "can","cannot","come","comment","comments","computer","con","cont","cool",
        "could","d","day","detail","dfpconf","did","differ","do","does","done", "dont","down", "downed", "downing", "downs", "Dr.","during",
        "e", "each", "early", "eg","either", "end", "ended", "ending","ends","et","even", "evenly", "ever", "every",
        "everybody", "everyone", "everything", "everywhere", "example","examples","f", "fact","family","far", "favorite",
        //"feature","features",
        "felt", "few","film","films","find","finds",
        "first", "following","for", "four", "friend","from", "full","fully","fun","further", "g", "gave", "general","generally",
        "get", "gets","girl","girls","give","given","gives","go","god","going","gonna","goods","got","guy","h","ha","had","haha","hahaha","has","have","having",
        "he","heart","hehe","her","here","herself","hey","hi","him","himself","his","home","hope","hour","hours","house","how","however","http","hug","i","idea","ie","if","im","in","into","is",
        //"israel",
        "issue","it","item","its", "itself", "j","jasondchen","jay","job","just","k","kakaazraff","keep","keeps","kid","kind","knew","know","known","knows","l","la",
        "last","later","latest","least","less","let","lets","life","like","likely","live","lol","lot",
        //"love",
        "luck","m","made","make","making",
        "man","may","me","men","might","mine","minute","month","more","morning","most","mostly","mother","movie","movies","mr","mrs","much","must","my","myself",
        "n","name","need","never","new","news","next","night","no","NO.","nobody","non","noon","not","note","nothing","now","nowhere","number",
        "numbers","o","of","off","often","ok","old","omg","on","once","one",
        //"online",
        "only","open","opened","opening","opens",
        "or","other","others","our","out","over","p",
        //"pakistan",
        "parent","part","parted","parting","parts","past","people","per","perhaps", "person","piece","pl",
        "place","places","please","pls","plz","point","pointed","pointing","points","possible","ppl","present","presented",
         "presenting","presents","problem","problems","product","products","put","puts","q","questions","quite","r","rather","really","reason","review","reviews","right","room",
         "rooms","rt","said","same","saturday","saw","say","says","second","seconds","see","seem","seemed","seeming",
         "seems","sees","self","selve","several","sg","shall","share","she","shit","shock","should","show","showed","showing","shows","side",
         "sides","since","so","some","somebody","someone","something","somewhere","state","states",
         "still","story","such","sure","t","take","taken","te","than","thank","that","the","their","them","then","there",
         "therefore","these","they","thing","things","think","thinks","this","those","though","thought",
         "thoughts","three","through","thus","tiffanyalvord","time","tmr","to","today","together","tomorrow","tonight","too","took","toward","turn",
         "turned","turning","turns","tweet","twitter","two","u","under","until","up","upon","ur","us","use","used","uses",
         "v","very","w","wanna","want","wanted","wanting","wants","was","way","ways","we","week","weeks","well","wells",
         "went","were","what","when","where","whether","which","while","who","whole","whose",
         "why","wife","will","with","within","without","women","word","work","worked","working","works","world","worlds","would","wow","x","xd",
         "y","yeah","year","years","yes","yesterday","yet","you","young","younger","youngest","your","yours","z","zhai","zhang","zhao","zhou","zhu","zizan"};
